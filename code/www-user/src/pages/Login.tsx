    ...
    return (
        <div className="min-h-screen bg-surface flex items-center justify-center px-4">
            <div className="bg-surface-card border border-border p-8 rounded-2xl shadow-2xl w-full max-w-md">
                ...
                {error && (
                    <div
                        className="flex items-center gap-2 text-red-400 bg-red-400/10 border border-red-400/20 p-3 rounded-lg mb-4 text-sm">
                        <svg
                ...
                {success && (
                    <div
                        className="flex items-center gap-2 text-emerald-400 bg-emerald-400/10 border border-emerald-400/20 p-3 rounded-lg mb-4 text-sm">
                        <svg
                            className="w-4 h-4 shrink-0"
                            fill="none"
                            viewBox="0 0 24 24"
