    ...
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
        <div className="bg-surface-card rounded-xl p-5 border border-border">
          ...
          <p className="text-sm text-muted mt-1">{teams.length > 1 ? "Equipes" : "Equipe"}</p>
        </div>
        ...
        >
          ...
          <p className="text-sm text-muted mt-1">{pendingCount > 1 ? "Invitations en attente" : "Invitation en attente"}</p>
        </Link>
        ...
        >
          ...
          <span className="text-accent font-medium text-sm">Creer une equipe</span>
        </Link>
      </div>
      ...
      {teams.length === 0 ? (
        <div className="bg-surface-card rounded-xl p-8 border border-border text-center">
          ...
          <p className="text-muted mb-4">Vous n'appartenez a aucune equipe pour le moment.</p>
          <Link
            to="/teams"
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="min-w-0">
                  <h3 className="font-medium truncate group-hover:text-accent transition-colors">{team.name}</h3>
