    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
                ...
                >
                    <div
                        className="w-12 h-12 bg-accent/10 rounded-full flex items-center justify-center group-hover:bg-accent/20 transition-colors">
                        <svg
            ...
            <h2 className="text-lg font-semibold mb-3">Mes équipes</h2>
            {teams.length === 0 ? (
                <div className="bg-surface-card rounded-xl p-8 border border-border text-center">
                    ...
                    <p className="text-muted mb-4">
                        Vous n'appartenez a aucune équipe pour le moment.
                    </p>
                    <Link
                        to="/teams"
                    ...
                    {teams.map((team) => (
                        ...
                        >
                            <div className="flex items-center gap-3">
                                <div
                                    className="w-9 h-9 bg-accent/10 rounded-lg flex items-center justify-center text-accent text-sm font-bold shrink-0">
