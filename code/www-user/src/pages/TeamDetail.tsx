...
export default function TeamDetail() {
    ...
    return (
        <div>
            ...
            <h1 className="text-2xl font-bold mt-3 mb-6">{team?.name ?? "Équipe"}</h1>
                ...
                <div className="lg:col-span-1 bg-surface-card rounded-xl border border-border p-5">
                    ...
                    <div className="space-y-2">
                        {members.map((m) => (
                            ...
                            >
                                <div
                                    className="w-8 h-8 rounded-full bg-accent/20 text-accent flex items-center justify-center text-sm font-medium shrink-0">
